...
import {Container, Title, Description, Brand, MenuBasket, ImgAboutWrapper, TriangleOne, TriangleTwo} from './styled';
    ...
    return (
        <Container>
            ...
            <Description>
                ...
                money on. Stores and websites offer an endless list<br/>
                of products.<br/>
