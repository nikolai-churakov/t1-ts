...
import {
    ...
    ResetButton,
    ProductContainer,
    ShowMoreButton, SelectionText
} from './styled';

const ITEMS: string[] = ['smartphones', 'laptops', 'sneakers', 'sneakers', 'sneakers', 'sneakers', 'sneakers', 'sneakers'];
const PRODUCTS = [
    {
        imgSrc: productImg,
    ...
    return (
        <Container>
            <Catalog>
                ...
                <CatalogParameters>
                    <SelectionText>Selection <br/> by parameters</SelectionText>
            ...
            <ProductContainer>
                {PRODUCTS.map(({imgSrc, name, coast} ) => <Product imgSrc={imgSrc} name={name} coast={coast}/>)}
